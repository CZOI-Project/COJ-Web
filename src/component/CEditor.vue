...
import modeCUrl from 'ace-builds/src-noconflict/mode-c_cpp?url'
...
ace.config.setModuleUrl('ace/mode/c_cpp', modeCUrl)
...
const props = defineProps({
  ...
  lang: {
    ...
    validator (value: any) {
      // 这个值必须匹配下列字符串中的一个
      return ['json5', 'protobuf', 'c_cpp'].includes(value)
    }
  },
  // 是否只读
  readonly: {
